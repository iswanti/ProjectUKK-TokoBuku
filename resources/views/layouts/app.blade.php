        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand " href="{{ route('home') }}">
                    <img src="{{ asset('images/rpl.png') }}" alt="Toko.Buku.Qu" class="brand-image img-circle elevation-3"
                        style="width:40px;">
                        <span class="brand-text font-weight-light">Toko.Buku.Qu</span>
                </a>
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        @if (Auth::user()->akses=='admin')
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownLap">
                                    <a href="{{ route('LaporanDataBuku') }}" class="dropdown-item">Semua Data Buku</a>
                                    <a href="{{ route ('FilterPenulis') }}" class="dropdown-item">Filter Penulis Buku</a>
                                    <a href="#" class="dropdown-item">Buku yang sering terjual</a>
                                    <a href="#" class="dropdown-item">Buku yang tidak pernah terjual</a>
                                    <a href="#" class="dropdown-item">Pasok Buku</a>
                                    <a href="#" class="dropdown-item">Filter Pasok Buku</a>
